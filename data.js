const DATA = {
  ...
  "rounds": [
    {
      ...
      "phase": "Constructora vs Instaladores"
    },
    {
      "id": 2,
      "seller": "B",
      ...
      "phase": "Instaladores vs Constructora"
    },
    {
      "id": 3,
      "seller": "C",
  ...
  "scenarios": {
    "A": {
      ...
      "clientRole": "Comprador de constructora: presiona por precio, pero teme retrasos y penalizaciones por plazo.",
      "clientHidden": [
      ...
      "successCommitment": "Reunión de planificación de suministros críticos de la obra."
    },
    "B": {
      ...
      "sellerContext": [
        ...
        "Compra material de reposición y urgencias.",
        "Decide por precio, pero sufre cuando no consigue material en plaza."
      ],
      "clientRole": "Instalador: busca precio bajo, pero necesita respuesta rápida y proveedor que no le falle cuando está en obra.",
      "clientHidden": [
      ...
      "successCommitment": "Revisión de referencias críticas para reducir compras urgentes."
    },
    "C": {
      ...
      "clientRole": "Responsable de mantenimiento: exige precio, pero su verdadera preocupación es que una línea no pare.",
      "clientHidden": [
      ...
      "successCommitment": "Listado de materiales críticos y plan de disponibilidad."
    },
    "D": {
      ...
      "successCommitment": "Sesión técnica previa para revisar criterios de especificación."
    }
  }
};